...
@Configuration
@EnableJpaRepositories(basePackages = "com.gc.chatapp.dao",
...
public class JpaConfiguration {
	...
	private Properties jpaProperties() {
		...
		properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("datasource.chatapp.hibernate.hbm2ddl.method"));
		properties.put("hibernate.show_sql", environment.getRequiredProperty("datasource.chatapp.hibernate.show_sql"));
		properties.put("hibernate.format_sql", environment.getRequiredProperty("datasource.chatapp.hibernate.format_sql"));
		if(StringUtils.isNotEmpty(environment.getRequiredProperty("datasource.chatapp.defaultSchema"))){
			properties.put("hibernate.default_schema", environment.getRequiredProperty("datasource.chatapp.defaultSchema"));
		}
		return properties;
	}
